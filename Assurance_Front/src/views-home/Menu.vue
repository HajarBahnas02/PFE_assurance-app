<template>
  <div class="menue">
    ...
    <div class="container-devis">
      ...
      <div v-if="showCardListauto" class="card-list">
        ...
        <div class="carde disabled" @click="goToPage('')">
  ...
  <div class="frame">
    ...
    <div class="cards-container">
      <div class="card">
        <img class="card-img" src="../assets/numero-un.png" alt="img simulation icon" />
        <h3 class="card-title">Réalisez votre simulation</h3>
        <p class="card-description">
          Remplissez notre formulaire de simulation d'assurance en ligne et sélectionnez
          les garanties adaptées à vos besoins pour obtenir votre tarif en moins de 2
          minutes.
        </p>
      </div>
      <div class="card">
        <img class="card-img" src="../assets/numero-2.png" alt="img simulation icon" />
        <h3 class="card-title">Souscrivez en ligne ou en agence</h3>
        <p class="card-description">
          Confirmez votre devis et finalisez votre souscription en choisissant un paiement
          en ligne sécurisé ou en payant par chèque à la réception de votre contrat
        </p>
      </div>
      <div class="card">
        ...
        <p class="card-description">
          Après avoir effectué le paiement, vous serez automatiquement assuré(e) et
          recevrez instantanément une copie de votre attestation d'assurance livrée à
      ...
      <div class="card">
        ...
        <p class="card-description">
          Inscrivez-vous sur l'espace client Shahed pour accéder à de nombreux services et
          consulter tous les détails de votre contrat 24h/24 et 7j/7 en ligne.
        </p>
      </div>
    </div>
    <div class="underPage">
  ...
  <h3 class="formule">Quelques clics suffisent pour effectuer votre inscription</h3>
  <div class="container-flex">
    <div class="floating-div">
      <img src="../assets/Frau.png" alt="grid" />
      <b>Remplissez les informations en ligne</b>
      <p>
        Afin que nous trouvions les tarifs qui vous conviennent à vous et à votre véhicule
      </p>
    </div>
    <div class="floating-div">
      ...
      <div class="testimonial-box-container">
        ...
        <div class="testimonial-box">
          ...
          <div class="client-comment">
            <p>
              Je suis ravi de mon expérience sur le site de Shahed. La facilité
              d'utilisation et la clarté des informations m'ont vraiment impressionné.
              C'est rare de trouver un site aussi intuitif et compréhensible
            </p>
          </div>
        </div>
        <!--BOX-2-------------->
        <div class="testimonial-box">
          ...
          <div class="client-comment">
            <p>
              Je recommande vivement ce service à tous ceux qui recherchent une protection
              fiable à un prix raisonnable.
            </p>
          </div>
        </div>
        <!--BOX-3-------------->
        <div class="testimonial-box">
          ...
          <div class="client-comment">
            <p>
              J'ai reçu une assistance immédiate à toutes mes questions, ce qui m'a
              vraiment mis en confiance. Bravo pour votre professionnalisme et votre
              réactivité !"
            </p>
          </div>
        </div>
        ...
        <div class="testimonial-box">
          ...
          <div class="client-comment">
            <p>
              Tout est clair, logique et cohérent. J'ai apprécié la transparence dans la
              manière dont les tarifs ont été calculés. Cela m'a permis de comprendre
              facilement ce pour quoi je payais. Un grand merci pour cette expérience
...
.carde.disabled {
  opacity: 0.9; /* Réduit l'opacité pour indiquer qu'il est désactivé */
  filter: grayscale(200%); /* Convertit l'image en niveaux de gris */
  pointer-events: none; /* Désactive les événements de pointer pour empêcher toute interaction */
}
...
.container-flex {
  ...
  margin-bottom: 40px;
  /* Espace sous les cartes d'appréciation */
}

.floating-div {
  flex: 1;
  min-width: 250px;
  /* Largeur minimale pour chaque div */
  max-width: 30%;
  /* Largeur maximale pour éviter d'être trop large */
  box-sizing: border-box;
  /* Inclure les padding et border dans la largeur */
  padding: 40px;
  /* Espace intérieur */
  margin: 3%;
  /* Espace vertical */
  background-color: #f8f9fa;
  /* Couleur de fond pour une meilleure visualisation */
  border: 1px solid #ddd;
  /* Bordure pour une meilleure visualisation */
  border-radius: 5px;
  /* Bordure arrondie */
  text-align: center;
  /* Centrer le texte */
...
.floating-div img {
  max-width: 100%;
  /* S'assurer que l'image est responsive */
  height: auto;
...
.floating-div b {
  display: block;
  /* S'assurer que <b> est un bloc pour le margin */
  margin-bottom: 10px;
  /* Espace sous le texte en gras */
}
...
.testimonial-container {
  ...
  justify-content: space-between;
  gap: 20px;
  /* Espace entre les cartes d'appréciation */
}
...
.testimonial-card {
  ...
  border-radius: 5px;
  text-align: left;
  /* Texte aligné à gauche pour les témoignages */
}
...
.overlay {
  ...
  z-index: 999;
  /* Assure que la superposition est au-dessus de tout autre contenu */
}

/* Ajoutez ce style pour empêcher les interactions avec les éléments sous-jacents */
.overlay.active {
  pointer-events: auto;
  /* L'utilisateur pourra interagir avec les éléments de la liste */
}
...
.card-list {
  ...
  z-index: 1000;
  /* Assure que la liste est au-dessus de la superposition */
  max-width: 70%;
...
.carde button {
  background-color: rgb(41, 140, 197);
...
#typewriter {
  overflow: hidden;
  /* Pour cacher le texte restant */
  border-right: 0.15em solid rgb(228, 216, 194);
  /* Curseur clignotant */
  white-space: nowrap;
...
.sous-titre {
  max-width: 800px;
  /* Pour limiter la largeur du texte */
  margin: 0 auto;
  /* Pour centrer le texte horizontalement */
  display: flex;
  /* Utiliser flexbox pour le centrage vertical */
  justify-content: center;
...
.conditions {
  flex: 1 50%;
  /* La moitié de la largeur de l'écran sur les écrans larges */
  max-width: 50%;
}
...
export default {
  ...
  methods: {
    ...
    showCards(type) {
      if (type === "auto") {
        this.showCardListauto = !this.showCardListauto;
      }
    },
    goToPage(route) {
