    ...
    public function sendMessage(Request $request)
{
    ...
    $clientPhoneNumber = $appClient->telephone;
    ...
    try {
        ...
        // Envoyer le message WhatsApp au numéro de téléphone du client
        $twilioClient->messages->create(
            "whatsapp:$clientPhoneNumber", // Numéro de téléphone du destinataire
            [
